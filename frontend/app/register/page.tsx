...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 px-4 py-10">
      {/* Background orbs */}
      <div className="orb -top-40 -right-40 h-96 w-96 bg-blue-400/20 dark:bg-blue-700/15" />
      <div className="orb bottom-0 -left-20 h-72 w-72 bg-cyan-400/15 dark:bg-cyan-700/10" />
