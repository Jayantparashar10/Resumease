    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">Recruiter Dashboard</h1>
            <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Manage your job postings</p>
          </div>
          <button
        ...
        {showForm && (
          ...
          >
            <h2 className="mb-4 font-semibold text-slate-900 dark:text-slate-100">New Job Posting</h2>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-300">Min. experience (years)</label>
                <input
                  type="number"
                  min={0}
        ...
        <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm">
            ...
            <p className="text-2xl font-bold text-slate-900 dark:text-slate-50">{jobs.length}</p>
            <p className="text-xs text-slate-400 dark:text-slate-500">Active job postings</p>
          </div>
        </div>

        {/* Jobs list */}
        <h2 className="mb-4 font-semibold text-slate-900 dark:text-slate-100">Your Job Postings</h2>
        {jobs.length === 0 ? (
