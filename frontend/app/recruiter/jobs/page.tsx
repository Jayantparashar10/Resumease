      ...
      <div className="min-h-screen bg-zinc-50">
        ...
        <main className="mx-auto max-w-5xl px-6 py-10">
          <div className="mb-6 flex items-center justify-between">
            <h1 className="text-2xl font-bold text-zinc-900">Recruiter Jobs</h1>
            <button
          ...
          {showForm ? (
            <form onSubmit={handleSubmit} className="mb-8 space-y-3 rounded-2xl border bg-white p-6">
              <input
                required
                value={form.title}
          ...
          {jobs.length === 0 ? (
            ...
            <div className="space-y-3">
              {jobs.map((job) => (
                <div key={job.id} className="flex items-start justify-between rounded-2xl border bg-white p-5">
                  <div>
