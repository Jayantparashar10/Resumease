...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 px-4">
      <div className="orb -top-40 -left-40 h-96 w-96 bg-blue-400/20 dark:bg-blue-700/15" />
      <div className="orb -bottom-20 -right-20 h-72 w-72 bg-cyan-400/15 dark:bg-cyan-700/10" />
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-slate-900 p-8 shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-sky-600 py-2.5 font-semibold text-white shadow-sm shadow-blue-500/25 hover:opacity-90 disabled:opacity-60 transition-opacity"
            >
